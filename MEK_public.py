...
Author: Kiriko Terai
Date: June 17, 2025
MEK infinite reservoir model for Nfn-1 from Kiriko
'''
import numpy as np
import math
import matplotlib
...
class Network():
    ...
    def evolve_new2(self, K_new: np.array, U_new: np.array, t: float, pop_init: np.array) -> np.array:
        """
        Evolve the population vector with a timestep of t
        Arguments:
        ...
        return U_new @ linalg.expm(K_new * t) @ np.linalg.inv(U_new) @ pop_init
