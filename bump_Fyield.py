...
but reservoir placement and D gap is like Nfn1. Updating F_slip --> F_sc, defined by the short circuit fluxes. Optimize for Fyield
'''
...
if __name__ == '__main__':
    ...
    df.to_csv(f"bump_Fyield_{task_id}_"+timestr+".csv", index=False)
