...
Author: Emily Wang
Nfn-1 modeled with infinite reservoir MEK. Iterate through a range of bump sizes. Fix all cofacotr distances to 10 Å
'''
...
if __name__ == '__main__':
    ...
    df.to_csv(f"Nfn1_varybump_fixDist_{task_id}_20250711.csv", index=False)